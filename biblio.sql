...
--
-- Hôte : 127.0.0.1:3308
-- Généré le : dim. 28 jan. 2024 à 07:36
...
CREATE TABLE IF NOT EXISTS `adherent` (
  ...
  `adrRue` varchar(50) COLLATE utf8mb3_bin DEFAULT NULL,
  `adrCP` mediumint DEFAULT NULL,
  `adrVille` varchar(25) COLLATE utf8mb3_bin DEFAULT NULL,
  `tel` varchar(10) COLLATE utf8mb3_bin DEFAULT NULL,
  `mel` varchar(25) COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`num`)
...
CREATE TABLE IF NOT EXISTS `auteur` (
  ...
  `numNationalite` smallint DEFAULT NULL,
  PRIMARY KEY (`num`),
...
CREATE TABLE IF NOT EXISTS `livre` (
  `num` smallint NOT NULL AUTO_INCREMENT,
  `isbn` varchar(13) COLLATE utf8mb3_bin NOT NULL,
  `titre` varchar(50) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `prix` float DEFAULT NULL,
  `editeur` varchar(25) COLLATE utf8mb3_bin DEFAULT NULL,
  `annee` smallint DEFAULT NULL,
  `langue` varchar(25) COLLATE utf8mb3_bin DEFAULT NULL,
  `numAuteur` smallint DEFAULT NULL,
  `numGenre` tinyint DEFAULT NULL,
  PRIMARY KEY (`num`),
...
CREATE TABLE IF NOT EXISTS `pret` (
  `num` smallint NOT NULL AUTO_INCREMENT,
  `numLivre` smallint NOT NULL DEFAULT '0',
  `numAdherent` smallint NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=451 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
