<div class="container mt-5">
    ...
    <form action="index.php?uc=genres&action=validForm" method="post"
        ...
        <div class="row mt-3">
            <div class="col-6"> <a href="index.php?uc=genres&action=list" class='btn btn-warning btn-block'>Revenir à
                    la liste</a>
            </div>
            <div class="col-6"><button type='submit' class='btn btn-success btn-block'> <?php echo $mode ?> </button>
            </div>
        </div>
    </form>
</div>