<div class="container mt-5">
    ...
    <div class="row pt-3">
        ...
        <div class="col-3"><a href="index.php?uc=nationalites&action=add" class='btn btn-success'><i class="bi bi-plus-circle me-1"></i>Ajouter une nationalité</a> </div>
        ...
        <tbody>
            ...
            foreach ($lesNationalites as $nationalite) {
                ...
                echo "<td class='col-md-2'>
                        <a href='index.php?uc=nationalites&action=update&num=". $nationalite->numero . "' class='btn btn-success'><i class='bi bi-pen'></i></a>
                        <a href='#deleteModal' data-bs-toggle='modal' data-message='Voulez vous supprimer cette nationalité ?' data-delete='index.php?uc=nationalites&action=delete&num=".$nationalite->numero ."' class='btn btn-danger'><i class='bi bi-trash'></i></a>
                    </td>";
                echo "</tr>";
            }
            ?>
